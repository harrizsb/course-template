...
export const materials: MaterialAsset[] = [
  {
    path: "handouts/freeze-checklist",
    file: "handouts/freeze-checklist.pdf",
    label: "Handout",
    title: "Freeze checklist handout",
    bytes: 329,
    dataUri: "data:application/pdf;base64,",
  },
  {
    path: "rubrics/final-presentation",
    file: "rubrics/final-presentation.pdf",
    label: "Rubric",
  ...
  {
    path: "rubrics/midterm",
    file: "rubrics/midterm.pdf",
    label: "Rubric",
