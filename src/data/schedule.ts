...
export const weeks: Week[] = [
  ...
  { week: 3, date: 'Sep 7, 2026', topic: 'Component architecture and design systems', readings: ['Starwind UI docs', 'Astro docs: Components'], materials: ['slides/week03.pdf'], assignmentId: 1 },
  ...
  { week: 5, date: 'Sep 21, 2026', topic: 'Forms, actions, and progressive enhancement', readings: ['Astro docs: Actions', 'MDN: Web forms'], materials: ['slides/week05.pdf'], assignmentId: 2 },
  ...
  { week: 8, date: 'Oct 12, 2026', topic: 'Midterm project checkpoint; code review workshop', readings: ['Team project rubric (Canvas)'], materials: ['rubrics/midterm.pdf'], assignmentId: 3 },
  ...
  { week: 10, date: 'Oct 26, 2026', topic: 'Performance budgets and Core Web Vitals', readings: ['web.dev: Web Vitals', 'web.dev: Performance budgets 101'], materials: ['slides/week10.pdf'], assignmentId: 4 },
  ...
  { week: 13, date: 'Nov 16, 2026', topic: 'Final project presentations', readings: ['Atlassian: Agile retrospectives'], materials: ['slides/week13.pdf', 'rubrics/final-presentation.pdf'], assignmentId: 5 },
];
